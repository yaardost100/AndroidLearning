$(document).ready(function() {
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('donutchart_con'));
        chart.draw(data, options);
        chart = new google.visualization.PieChart(document.getElementById('donutchart_bus'));
        chart.draw(data, options);
    }
...
function PerformanceClick() {
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.Gauge(document.getElementById('performance-charts'));
